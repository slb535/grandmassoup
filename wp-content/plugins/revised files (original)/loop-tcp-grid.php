...
<?php if ( ! have_posts() ) : ?>
      <article id="post-0" class="post no-results not-found">
          ...
          <div class="entry-content">
              <p><?php _e( 'Apologies, but no results were found for the requested archive. Perhaps searching will help find a related product.', 'twentyeleven' ); ?>
            </p>
              <?php get_search_form(); ?>
          </div><!-- .entry-content -->
      </article><!-- #post-0 -->
...
<?php while ( have_posts() ) : the_post();
	...
	<?php $column--;?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<?php if ( $see_title ) : ?>
				<?php echo $title_tag;?><?php the_title(); ?><?php echo $title_end_tag;?> <!-- I HAVE REMOVED THE LINK AROUND THIS TITLE -->
			<?php endif; ?>
