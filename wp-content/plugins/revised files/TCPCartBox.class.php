	...
	function show() {
		...
		<div id="cart_layer_info" class="checkout_info clearfix">
			...
			$this->show_order_cart( $shipping_country, $settings );
		 	...
		 	<br /><br /><div class="tcp_go_to_shopping_cart"><a href="<?php tcp_the_shopping_cart_url(); ?>"><?php _e( 'Shopping Cart', 'tcp' ); ?></a></div><!-- .tcp_go_to_shopping_cart -->
			<div class="tcp_comment"><label for="comment"><?php _e( 'Please indicate any and all necessary meal preparation instructions: (Food allergies, no dairy, low sodium, etc.)', 'tcp' ); ?></label><br />
