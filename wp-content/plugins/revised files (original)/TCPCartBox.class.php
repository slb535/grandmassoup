	...
	function show() {
		...
		<div id="cart_layer_info" class="checkout_info clearfix">
			...
			$this->show_order_cart( $shipping_country, $settings );
		 	...
		 	<div class="tcp_go_to_shopping_cart"><a href="<?php tcp_the_shopping_cart_url(); ?>"><?php _e( 'Back to Shopping Cart', 'tcp' ); ?></a></div><!-- .tcp_go_to_shopping_cart -->
            <BR /><BR />
			<div class="tcp_comment"><strong><label for="comment"><?php _e( 'Food Allergies/Prep Instruction: (ie. no spicy food, no nuts, gluten free):', 'tcp' ); ?></label></strong><br />
